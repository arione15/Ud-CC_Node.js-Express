...
app.post('/movies', urlencodedParser, (req, res) => {
    ...
    res.sendStatus(201);
    const newMovie = {title: req.body.movietitle, year: req.body.year};
    frenchMovies.push(newMovie); // ou bien frenchMovies=[...frenchMovies, newMovie]; mais dans ce cas on crée une copie du tableau
